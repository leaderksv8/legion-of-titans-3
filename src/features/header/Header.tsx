...
import { nav, type Locale } from "@/content/site";
            ...
            <a href="/#home" className="inline-flex items-center gap-3 logo-link min-w-0">
              ...
              <span className="min-w-0 text-white">
                <span className="hidden max-[420px]:block leading-tight">
                  <span className="block text-[10px] tracking-[0.22em] uppercase text-ash/80">ГО</span>
                  <span className="block text-[13px] font-semibold tracking-[0.10em]">«Легіон Титанів»</span>
                </span>
