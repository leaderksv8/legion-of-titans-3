...
export const guide: Record<Locale, GuideContent> = {
  uk: {
    ...
    quickStart: [
      ...
      {
        id: "housing",
        title: "Постанова на квартирну чергу облік, покращення житлових умов",
        steps: ["1) Зібрати документи про поточні житлові умови", "2) Подати заяву до місцевої ради", "3) Дочекатися рішення комісії про постановку на облік"],
        docs: ["Паспорт", "ІПН", "Посвідчення УБД", "Довідка про склад сім'ї", "Документи на поточне житло", "Заява на постановку на облік"],
        tags: ["Житло", "Пільги"],
      },
    ],
    updates: [
